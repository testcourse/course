...
totaly <- merge(totaly, activities, by.x="ActivityID", by.y="ActivityID",all=FALSE);
...
tidyDataSet <- aggregate(set2[,1:66], by=list(Subject=set2$Subject,Activity=set2$Activity),mean);
